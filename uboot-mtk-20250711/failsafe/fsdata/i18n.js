...
const I18N = {
    en: {
        ...
        "settings.storage.mtd_layout": "MTD layout:",
        "settings.storage.help": "Pick a partition layout exposed by the device tree. Empty keeps the device default.",
        "settings.failsafe.auto_reboot": "Auto reboot after upgrade:",
        "settings.telnet.enable": "Enabled:",
        "settings.telnet.port": "Port:",
        "settings.dhcpd.verbose": "Verbose log:",
    ...
    "zh-cn": {
        ...
        "settings.storage.mtd_layout": "MTD 分区布局：",
        "settings.storage.help": "选择设备树中导出的分区布局，留空保留当前布局。",
        "settings.failsafe.auto_reboot": "升级后自动重启：",
        "settings.telnet.enable": "启用：",
        "settings.telnet.port": "端口：",
        "settings.dhcpd.verbose": "详细日志：",
